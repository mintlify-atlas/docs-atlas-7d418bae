...
<CardGroup cols={2}>
  ...
  <Card title="Add Model Support" icon="puzzle-piece" href="/supported-models/extending/support-new-models">
...
<CardGroup cols={2}>
  ...
  <Card title="Multi-Node Deployment" icon="server" href="/references/multi-node-deployment">
