...
<Accordion title="Common Sampling Parameters">
  ...
  See [Sampling Parameters](/basic-usage/sampling-params) for the complete list.
</Accordion>
...
<Accordion title="Slow inference">
  ...
  - See [Hyperparameter Tuning](/advanced-features/hyperparameter-tuning) for optimization
</Accordion>
...
<CardGroup cols={2}>
  <Card title="Server Arguments" icon="sliders" href="/advanced-features/server-arguments">
    Learn about all available server configuration options
  </Card>
  <Card title="Sampling Parameters" icon="dice" href="/basic-usage/sampling-params">
    Control generation behavior with sampling parameters
  </Card>
  <Card title="Model Support" icon="cube" href="/supported-models">
    Browse supported models and architectures
  </Card>
  <Card title="Production Deployment" icon="server" href="/advanced-features/observability">
